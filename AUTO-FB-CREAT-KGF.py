...
hx=(f"""  [bold green1]DEVELOPER[medium_purple1]   ⟩ [bold green1]BRYXPOGI
  ...
  [bold green1]TOOL/STATUS[medium_purple1] ⟩ [bold green1]FREE / KALYAN KING/KGF CYBER TEAM
  [bold green1]TG @KGF_BD_TEAM[medium_purple1]  ⟩ [bold green1]{ll}
  [bold green1]IP COUNTRY[medium_purple1]  ⟩ [bold green1]{kk}""")
def banner():
    os.system("clear")
    os.system("xdg-open https://t.me/KGF_BD_TEAM")
...
def main_apv():
    ...
    if id in r1:
        ...
        tks = ('Hello%20Bryx%20Owner%20BRYXPOGI%20!!%20Please%20Approve%20My%20Key%20:%20'+id);os.system('am start https://t.me/ZERO_CYBER_TEM'+tks)
        main_apv()
