...
def old_Tow():
    ...
    for _ in range(int(limit)):
     ...
     # ======================================================
    # 🔥 BAGIAN PENTING: total_ids ADA DI SINI
    # ======================================================
    global total_ids
    total_ids = len(user)
    # ======================================================
...
def login_1(uid):
    ...
    try:
        ...
        # ===== PROGRESS BAR BLACK & GOLD PREMIUM =====
        percent = int((loop / total_ids) * 100)
        if percent > 100:
            percent = 100
        ...
        bar = (
            "\033[38;5;220m" + "█" * fill +
            "\033[38;5;236m" + "░" * (bar_len - fill)
        )  # ← Kurung tutup benar

        sys.stdout.write(
            f"\r\033[1;30m[\033[0m{bar}\033[1;30m]\033[0m "
            f"\033[38;5;220m{percent:3d}%\033[0m  "
            f"\033[38;5;46mOK:\033[1;37m{len(oks)}  "
            f"\033[38;5;196mCP:\033[1;37m{len(cps)}"
        )
        sys.stdout.flush()
