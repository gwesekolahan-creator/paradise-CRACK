# Decrypted output produced by decrypt_tool.py
#▬▭▬▭▬▭▬▭[IMPORT]▬▭▬▭▬▭▬▭#
import os,sys,re,time,json,mechanize,asyncio,aiohttp,requests,urllib.parse,bs4,string,faker,fake_email,random,uuid,hashlib,subprocess,platform,marshal,zlib,base64,locale
...
{style} \033[1;32mVERSION  \033[1;37m: \033[1;32m1.1""")
#▬▭▬▭▬▭▬▭[CLEAR]▬▭▬▭▬▭▬▭#
def clear():
...
def ____create____():
    ...
    linex()
    while True:
        sys.stdout.write(f"\r\r\033[1;37m[\033[1;32mFINDING-CREATE\033[1;37m]\033[1;37m-\033[1;37m[\033[1;32mOK\033[1;37m•\033[1;32m{len(oks)}\033[1;37m]\033[1;37m");
        sys.stdout.flush()
        ...
        response=requests.get('https://www.facebook.com/?_rdc=1&_rdr',cookies=cookies,headers=headers,timeout=20)
        ...
        try:
            c=response=requests.post('https://web.facebook.com/ajax/register.php',headers=headers,data=data,timeout=25)
        except Exception:
            continue
        if '"registration_succeeded":true' in c.text:
            ...
            print(f'\r\r\033[1;32m[ERROR-SUCCESS💚] {uid} | {password}')
            if 'y' in coki:
            ...
            append_line("MR-ERROR-AUTO-CRATE-M1-COOKIE.txt", f"{uid} | {password} | {cookie_str}")
            append_line("MR-ERROR-AUTO-CRATE-M1-OK.txt",      f"{uid} | {password}")
