    ...
    "User-Agent": str(random.choice([
        ...
        "x-fb-connection-token": "d29d67d37eca387482a8a5b740f84f62"
            ...
            if 'session_key' in res:
                ...
                # Ambil User-Agent real
                ua = headers.get("User-Agent", "UNKNOWN-UA")

                # Ambil cookies dari hasil login (GRAF FB hanya kirim dari sini)
            ...
            # ===================== LOGIN CP / GAGAL =====================
                ...
                print(f"\033[91m❌ STATUS : CP\033[0m")
