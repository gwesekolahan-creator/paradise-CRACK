...
def realtime(uid, pw):
    with realtime_lock:
        total = len(oks) + len(softcps) + len(cps)
        ...
        panel = (
            ...
            f"│ \033[96mTOTAL    : \033[97m{total:<40}\033[38;5;51m│\n"
            f"├" + "─" * 52 + "┤\n"
...
def login_1(uid):
    ...
    try:
        ...
        sys.stdout.write(
            f"\r"
            f"\x1b[38;5;45m◢\x1b[38;5;87m◤\x1b[38;5;159m⧫ "  # hologram edge
            f"\x1b[1;38;5;51m《HOLO-HUD PRDS》 "
            f"\x1b[38;5;159m⟦\x1b[38;5;51mLoop: {loop}\x1b[38;5;159m⟧ "
            f"\x1b[38;5;159m⟦\x1b[38;5;87mOK: {len(oks)}\x1b[38;5;159m⟧  "
            f"\x1b[38;5;45m◢"
            f"\x1b[38;5;87m{bar_filled}"
            f"\x1b[38;5;240m{bar_empty}"
            f"\x1b[38;5;45m◣"
        )
        sys.stdout.flush()
