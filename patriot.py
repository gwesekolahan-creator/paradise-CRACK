...
BASE_DIR = "/data/data/com.termux/files/home/storage/shared/PATRIOT"
...
└──────────────────────────────┘{w}
""")
                open("/data/data/com.termux/files/home/storage/shared/PARADISE.txt", "a").write(f"{uid}|{pw}\n")
                oks.append(uid)
                break
